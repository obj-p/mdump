...
//
#ifndef SimPasteboardSyncPoolObject_h
#define SimPasteboardSyncPoolObject_h
@import Foundation;

@interface SimPasteboardSyncPoolObject : NSObject

@property (nonatomic) unsigned long long lastSeenChangeCount;
@property (nonatomic) unsigned long long regID;

/* instance methods */
- (id)initWithPasteboard:(id)pasteboard;
@end

#endif /* SimPasteboardSyncPoolObject_h */
